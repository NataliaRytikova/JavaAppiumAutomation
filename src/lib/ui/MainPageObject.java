...
public class MainPageObject {
    ...
    public WebElement waitForElementEndSendKeys(By by, String value, String error_message, long timeOutInSeconds)
    {
    ...
    public WebElement waitForElementEndClick(By by, String error_message, long timeOutInSeconds)
    {
        WebElement element = waitForElementPresent(by, error_message, timeOutInSeconds);
        element.click();
        return element;
